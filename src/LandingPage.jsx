  ...
  return (
    <div className="h-screen w-full flex flex-row">
      <div className=" hover:w-[80%] ease-in duration-700 w-1/2 h-full flex justify-center items-center bg-[#1293D3]  ">
        ...
        <div className="texts z-10 gap-12 w-[30%] text-center text-white flex flex-col  h-[50%] absolute">
      ...
      <div className=" w-1/2 hover:w-[80%] ease-in duration-700 h-full flex justify-center items-center bg-[#F69C09] ">
        ...
        <div className="texts z-10 gap-10 w-[30%] text-white flex flex-col h-[50%] absolute">
          ...
          <h1 className=" uppercase italic font-extrabold text-[70px] leading-none ">
            because <br />
            i'm happy <br />
            again
          </h1>
          ...
          <button  onClick={ScrollToTicket} className=" w-56 h-12 flex gap-2 items-center justify-center backdrop-blur-sm rounded-3xl border-slate-50 border-2  ">
